...
class ConfirmPage_Tiktok extends StatefulWidget {
  final File videofile;
  final String videopath_astring;
  final ImageSource imageSource;
  final User user;

  ConfirmPage_Tiktok(this.videofile, this.videopath_astring, this.imageSource, {required this.user});
  @override
  _ConfirmPage_TiktokState createState() => _ConfirmPage_TiktokState();
}

class _ConfirmPage_TiktokState extends State<ConfirmPage_Tiktok> {
